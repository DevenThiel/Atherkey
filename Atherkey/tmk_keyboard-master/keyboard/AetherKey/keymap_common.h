...
#define KEYMAP( \
    ...
    K40, K41, K42, K43,                K47,           K4A, K4B, K4C, K4D, K4E, K4F  \
) { \
    ...
    { KC_##K40, KC_##K41, KC_##K42, KC_##K43,    KC_NO,    KC_NO,    KC_NO, KC_##K47,    KC_NO,    KC_NO, KC_##K4A, KC_##K4B, KC_##K4C, KC_##K4D, KC_##K4E, KC_##K4F }  \
}
